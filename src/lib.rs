...
pub fn eval(form: &Expr, env: &mut Env) -> Result<Rc<SLVal>, String> {
    match form {
        ...
        //         "let" => {
        //             match *right {
        //                 AValue::Cons(var, box_cons_expr) => match *var {
        //                     AValue::Symbol(variable_name) => match *box_cons_expr {
        //                         AValue::Cons(box_expr, box_hopeful_nil) => match *box_hopeful_nil {
        //                             AValue::Nil => {
        ...
        //                 },
        //                 _ => Err("`let` must have two arguments, a symbol and an expression."
        //                     .to_string()),
        //             }
        //         }

...
#[case::std_not_true("[fn main [] ->Bool [std::not true]]", SLValue::Bool(false))]
#[case::std_not_false("[fn main [] ->Bool [std::not false]]", SLValue::Bool(true))]
#[case::std_not_expr("[fn main [] ->Bool [std::not (3 == 4)]]", SLValue::Bool(true))]
#[case::prelude_std_not("[fn main [] ->Bool [not true]]", SLValue::Bool(false))]
